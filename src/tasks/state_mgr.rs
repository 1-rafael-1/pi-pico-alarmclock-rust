...
// For now the idea is to do a small version of dependenbcy injection and pass this class around to the other tasks that need it; none of that yet implemented
